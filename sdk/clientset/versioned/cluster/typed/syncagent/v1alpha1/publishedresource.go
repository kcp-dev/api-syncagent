...
// or scope down to one cluster and return a syncagentv1alpha1client.PublishedResourceInterface.
type PublishedResourceClusterInterface interface {
	Cluster(logicalcluster.Path) syncagentv1alpha1client.PublishedResourceInterface
	List(ctx context.Context, opts metav1.ListOptions) (*syncagentv1alpha1.PublishedResourceList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
}

type publishedResourcesClusterInterface struct {
	clientCache kcpclient.Cache[*syncagentv1alpha1client.SyncagentV1alpha1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *publishedResourcesClusterInterface) Cluster(clusterPath logicalcluster.Path) syncagentv1alpha1client.PublishedResourceInterface {
...
func (c *publishedResourcesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*syncagentv1alpha1.PublishedResourceList, error) {
