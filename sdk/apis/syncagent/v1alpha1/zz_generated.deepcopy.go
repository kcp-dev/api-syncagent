...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionProjection) DeepCopyInto(out *VersionProjection) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionProjection.
func (in *VersionProjection) DeepCopy() *VersionProjection {
	if in == nil {
		return nil
	}
	out := new(VersionProjection)
	in.DeepCopyInto(out)
	return out
}
