...
// PublishedResourceApplyConfiguration represents a declarative configuration of the PublishedResource type for use
// with apply.
...
// PublishedResource constructs a declarative configuration of the PublishedResource type for use with
// apply.
func PublishedResource(name string) *PublishedResourceApplyConfiguration {
	...
	b.WithAPIVersion("syncagent.kcp.io/v1alpha1")
	return b
}
...
func (b *PublishedResourceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
